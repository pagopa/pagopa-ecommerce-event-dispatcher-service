...
| TRANSACTIONS_AUTHORIZATION_REQUESTED_RETRY_QUEUE_NAME        | Queue name for payment gateway authorization requested retry transactions                                                                                                                                                                                          | string  |               |
...
| AUTHORIZATION_REQUESTED_RETRY_EVENT_BASE_INTERVAL_SECONDS    | Base interval used to calculate visibility for next payment gateway auth state request event                                                                                                                                                                       | string  |               |
| AUTHORIZATION_REQUESTED_RETRY_EVENT_MAX_ATTEMPTS             | Max attempts to be performed for payment gateway auth state request                                                                                                                                                                                                | string  |               |
