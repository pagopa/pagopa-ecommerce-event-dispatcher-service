...
| AUTHORIZATION_OUTCOME_WAITING_EVENT_BASE_INTERVAL_SECONDS    | Base interval used to calculate visibility for next payment gateway auth state request event                                                                                                                                                                       | string  |               |
| AUTHORIZATION_OUTCOME_WAITING_EVENT_MAX_ATTEMPTS             | Max attempts to be performed for payment gateway auth state request                                                                                                                                                                                                | string  |               |
