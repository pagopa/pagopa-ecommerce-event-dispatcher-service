...
class TransactionClosePaymentRetryQueueConsumer(
                ...
                it.fold(
                  {
                     ...
                     */
                    ClosePaymentRequestV2KODto.OutcomeEnum.KO
                  },
                  {
                    /*
                    ...
                    when (trxWithAuthorizationCompleted.transactionAuthorizationCompletedData
                      ...
                      AuthorizationResultDto.OK -> ClosePaymentRequestV2KODto.OutcomeEnum.OK
                      AuthorizationResultDto.KO -> ClosePaymentRequestV2KODto.OutcomeEnum.KO
                      else ->
  ...
  private fun updateTransactionStatus(
    ...
    closureOutcome: ClosePaymentRequestV2KODto.OutcomeEnum,
    ...
    val newStatus =
      if (canceledByUser) {
        ...
        when (closureOutcome) {
          ClosePaymentRequestV2KODto.OutcomeEnum.OK -> TransactionStatusDto.CLOSED
          ClosePaymentRequestV2KODto.OutcomeEnum.KO -> TransactionStatusDto.UNAUTHORIZED
        }
      }
