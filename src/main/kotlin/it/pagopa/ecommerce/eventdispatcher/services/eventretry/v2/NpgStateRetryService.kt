...
class NpgStateRetryService(
  @Autowired private val npgStateRetryQueueAsyncClient: QueueAsyncClient,
  @Value("\${transactionsAuthRequestedRetry.eventOffsetSeconds}") private val closePaymentRetryOffset: Int,
  @Value("\${transactionsAuthRequestedRetry.maxAttempts}") private val maxAttempts: Int,
  ...
  @Value("\${transactionsAuthRequestedRetry.paymentTokenValidityTimeOffset}")
  ...
  RetryEventService<TransactionClosureRetriedEvent>(
    queueAsyncClient = npgStateRetryQueueAsyncClient,
