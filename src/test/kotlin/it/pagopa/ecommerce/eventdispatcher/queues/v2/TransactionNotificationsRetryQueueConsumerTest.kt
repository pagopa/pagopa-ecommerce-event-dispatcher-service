...
class TransactionNotificationsRetryQueueConsumerTest {
  ...
  private val transactionNotificationsRetryQueueConsumerViewUpdateEnabled =
    createConsumerWithViewUpdateEnabled()
  private val transactionNotificationsRetryQueueConsumerViewUpdateDisabled =
  ...
  fun `Should successfully retry send user email for send payment result outcome OK`() = runTest {
    ...
    StepVerifier.create(
        transactionNotificationsRetryQueueConsumerViewUpdateEnabled.messageReceiver(
  ...
  @Test
  fun `Should successfully retry send user email for send payment result outcome OK with transactions-view update disabled`() =
    runTest {
      val transactionUserReceiptData =
        transactionUserReceiptData(TransactionUserReceiptData.Outcome.OK)
      val notificationErrorEvent = transactionUserReceiptAddErrorEvent(transactionUserReceiptData)
      ...
      StepVerifier.create(
          transactionNotificationsRetryQueueConsumerViewUpdateDisabled.messageReceiver(
            Either.left(QueueEvent(notificationErrorEvent, MOCK_TRACING_INFO)), checkpointer))
        .expectNext(Unit)
        .verifyComplete()
      verify(checkpointer, times(1)).success()
  ...
  @Test
  fun `Should successfully retry send user email for send payment result outcome OK with legacy event with transactions-view update disabled`() =
    runTest {
      val transactionUserReceiptData =
        transactionUserReceiptData(TransactionUserReceiptData.Outcome.OK)
      val notificationErrorEvent = transactionUserReceiptAddErrorEvent(transactionUserReceiptData)
  ...
  @Test
  fun `Should enqueue notification retry event for failure calling notification service send payment result outcome OK with transactions-view update disabled`() =
    runTest {
      val transactionUserReceiptData =
        transactionUserReceiptData(TransactionUserReceiptData.Outcome.OK)
      val notificationErrorEvent = transactionUserReceiptAddErrorEvent(transactionUserReceiptData)
  ...
  @Test
  fun `Should enqueue notification retry event for failure retry calling notification service send payment result outcome OK with transactions-view update disabled`() =
    runTest {
      val attempt = 1
      val transactionUserReceiptData =
        transactionUserReceiptData(TransactionUserReceiptData.Outcome.OK)
  ...
  @Test
  fun `Should enqueue notification retry event for failure retry calling notification service send payment result outcome OK with legacy event with transactions-view update disabled`() =
    runTest {
      val attempt = 1
      val transactionUserReceiptData =
        transactionUserReceiptData(TransactionUserReceiptData.Outcome.OK)
  ...
  @Test
  fun `Should enqueue notification retry event for failure retry calling notification service send payment result outcome KO with transactions-view update disabled`() =
    runTest {
      val attempt = 1
      val transactionUserReceiptData =
        transactionUserReceiptData(TransactionUserReceiptData.Outcome.KO)
  ...
  @Test
  fun `Should not request refund for no left attempts resending mail for send payment result OK with transactions-view update disabled`() =
    runTest {
      val attempt = 3
      val transactionUserReceiptData =
        transactionUserReceiptData(TransactionUserReceiptData.Outcome.OK)
  ...
  private fun createConsumerWithViewUpdateEnabled(): TransactionNotificationsRetryQueueConsumer {
    return createConsumerWithViewUpdate(true)
  }

  private fun createConsumerWithViewUpdateDisabled(): TransactionNotificationsRetryQueueConsumer {
    return createConsumerWithViewUpdate(false)
  }

  private fun createConsumerWithViewUpdate(
    viewUpdateEnabled: Boolean = true
  ): TransactionNotificationsRetryQueueConsumer {
    return TransactionNotificationsRetryQueueConsumer(
      ...
      transactionsViewUpdateEnabled = viewUpdateEnabled)
  }
}
