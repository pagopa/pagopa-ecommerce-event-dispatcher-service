...
class NotificationsServiceClientTest {
    ...
    fun shouldReturnEmailOutcome() {
        val notificationEmailRequest = NotificationEmailRequestDto()
            .language("it-IT")
            .subject("subject")
            .to("foo@example.com")
            .templateId("template-id")
            .parameters(mapOf(Pair("param1", "value1")))
        val expected = NotificationEmailResponseDto()
            .outcome("OK")
    ...
    fun shouldReturnEmailOutcomeWithSuccessTemplate() {
        ...
        val request = NotificationEmailRequestDto()
    ...
    fun shouldReturnEmailOutcomeWithKoTemplate() {
        val koTemplateRequest = NotificationsServiceClient.KoTemplateRequest(
            "foo@example.com",
    ...
    fun shouldReturnMonoErrorForExceptionDuringNotificationServiceInvocation() {
        ...
        given(defaultApi.sendNotificationEmail(apiKey, request)).willReturn(Mono.error(RuntimeException("Error")))
        StepVerifier.create(client.sendNotificationEmail(request))
    ...
    fun shouldReturnMonoErrorForExceptionThrownDuringNotificationServiceInvocation() {
        ...
        given(defaultApi.sendNotificationEmail(apiKey, request)).willThrow(
