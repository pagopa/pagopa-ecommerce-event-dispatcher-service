...
class UserReceiptMailBuilderTest {
    ...
    @Test
    fun `Should build success email for notified transaction with send payment result outcome OK`() = runTest {
        /*
         * Prerequisites
         */
        given(confidentialMailUtils.toEmail(any())).willReturn(Email(TransactionTestUtils.EMAIL_STRING))
        val events = listOf<TransactionEvent<*>>(
            ...
            TransactionTestUtils.transactionAuthorizationCompletedEvent(AuthorizationResultDto.OK) as TransactionEvent<*>,
            TransactionTestUtils.transactionClosedEvent(TransactionClosureData.Outcome.OK) as TransactionEvent<*>,
        ...
        val baseTransaction =
            TransactionTestUtils.reduceEvents(*events.toTypedArray()) as BaseTransactionWithRequestedUserReceipt
        val successTemplateRequest = NotificationsServiceClient.SuccessTemplateRequest(
            "foo@example.com",
        ...
        val expected = NotificationEmailRequestDto()
         ...
         * Test
         */
        val notificationEmailRequest = userReceiptMailBuilder.buildNotificationEmailRequestDto(baseTransaction)
        /*
         * Assertions
         */
